...
import { COLORS, CONSTANTS, MESSAGES, ROUTES } from '../../constants';
import { Image, Text, ButtonIcon, Link } from '../core';
      ...
      <Container>
        ...
        <ELementContainer>
          <Link to={ROUTES.CONTACT}>
            <ButtonIcon fontSize='25px' color={COLORS.PALETTE.TEXT_BLACK}>
